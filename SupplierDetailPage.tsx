  ...
  <div className="card" style={{ position: 'relative' }}>
    ...
    <div className="card-body" onClick={onClick} style={{ cursor: 'pointer' }}>
      ...
      <div className="card-foot">
        <span className="card-price" style={{ fontSize: 11 }}>{space.price_per_hour ? `A partir de R$ ${space.price_per_hour.toLocaleString('pt-BR')}` : space.price_per_day ? `A partir de R$ ${space.price_per_day.toLocaleString('pt-BR')}` : 'Consulte o valor'}</span>
