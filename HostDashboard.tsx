        ...
        <div style={{ padding: '20px 28px', borderBottom: '1px solid #e8e8e8', background: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          <div>
            <h1 style={{ fontSize: 19, fontWeight: 800, marginBottom: 2 }}>
              {tab === 'espacos' ? 'Meus espaços' : tab === 'orcamentos' ? 'Orçamentos recebidos' : tab === 'dados' ? 'Meus dados' : 'Central de suporte'}
            </h1>
          ...
          {tab === 'espacos' && (
            <div style={{ display: 'flex', gap: 10 }}>
              <button onClick={() => goToPage('host-quotes')} style={{ fontSize: 12, padding: '9px 14px', fontWeight: 600, background: '#fff', border: '1.5px solid #e8e8e8', borderRadius: 8, cursor: 'pointer', color: '#2d2d2d', fontFamily: 'inherit' }}>📋 Ver orçamentos</button>
